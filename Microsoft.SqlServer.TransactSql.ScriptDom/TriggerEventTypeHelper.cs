...
namespace Microsoft.SqlServer.TransactSql.ScriptDom
{
	...
	{
		// Token: 0x06000304 RID: 772 RVA: 0x0000A214 File Offset: 0x00008414
		private TriggerEventTypeHelper()
		{
			...
			base.AddOptionMapping(EventNotificationEventType.CreateDatabaseAudit, "CREATE_AUDIT", SqlVersionFlags.TSql120);
			base.AddOptionMapping(EventNotificationEventType.DropDatabaseAudit, "DROP_AUDIT", SqlVersionFlags.TSql120);
			base.AddOptionMapping(EventNotificationEventType.AlterDatabaseAudit, "ALTER_AUDIT", SqlVersionFlags.TSql120);
		}
